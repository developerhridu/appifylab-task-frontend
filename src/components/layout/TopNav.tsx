...
// Top navigation ported from design-reference/feed.html. Icons/search and the
// notification list are static (no backend for those features yet); the profile
// name/avatar and Log out are wired to real auth.
      ...
      <div className="container _custom_container">
        ...
        <div className="collapse navbar-collapse show" id="navbarSupportedContent">
          ...
          <ul className="navbar-nav mb-2 mb-lg-0 _header_nav_list ms-auto _mar_r8">
            ...
            <li className="nav-item _header_nav_item">
              <span className="nav-link _header_nav_link" role="button" tabIndex={0}>
          ...
          <div className="_header_nav_profile">
            <div className="_header_nav_profile_image" style={{ width: 40 }}>
              {user && <Avatar firstName={user.firstName} lastName={user.lastName} size={40} />}
            </div>
            <div className="_header_nav_dropdown" onClick={() => setProfileOpen((v) => !v)}>
            ...
            <div className={`_nav_profile_dropdown _profile_dropdown${profileOpen ? " show" : ""}`}>
              <div className="_nav_profile_dropdown_info">
                <div className="_nav_profile_dropdown_image">
                  {user && <Avatar firstName={user.firstName} lastName={user.lastName} size={54} />}
                </div>
              ...
              <ul className="_nav_dropdown_list">
                ...
                <li className="_nav_dropdown_list_item">
                  <button
                    ...
                    style={{ border: 0, background: "none", width: "100%", cursor: "pointer" }}
                  >
                    <div className="_nav_drop_info">
                      <span>
