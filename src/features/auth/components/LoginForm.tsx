                  ...
                  <div className="row">
                    <div className="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                      <div className="_social_login_form_input _mar_b14">
                        ...
                        />
                        {errors.email && (
                          <span style={{ color: "#e5484d", fontSize: 13 }}>{errors.email.message}</span>
                        )}
                      </div>
                    </div>
                    <div className="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                      <div className="_social_login_form_input _mar_b14">
                        ...
                        />
                        {errors.password && (
                          <span style={{ color: "#e5484d", fontSize: 13 }}>{errors.password.message}</span>
                        )}
                      </div>
                    </div>
                  </div>
                  <div className="row">
                    <div className="col-lg-12 col-md-12 col-xl-12 col-sm-12">
                      <div className="_social_login_form_btn _mar_t40 _mar_b60">
                        <button type="submit" className="_social_login_form_btn_link _btn1" disabled={login.isPending}>
                          {login.isPending ? "Logging in..." : "Login now"}
                        </button>
                      </div>
                    </div>
                  </div>
